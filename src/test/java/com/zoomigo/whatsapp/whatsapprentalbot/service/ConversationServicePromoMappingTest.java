...
public class ConversationServicePromoMappingTest {
    ...
    public void bikeSpecificPromo_applies_only_to_mapped_bike() {
        ...
        Bike bike1 = new Bike();
        bike1.setId(1L);
        bike1.setName("Honda PCX 150");
        bike1.setPricePerDay(2500);
        bike1.setDeposit(2500);
        when(bikeRepo.findById(1L)).thenReturn(Optional.of(bike1));

        PromoCode p = new PromoCode();
        p.setId(10L);
        p.setCode("BIKE1_100");
        p.setDiscountAmount(100);
        p.setActive(true);
        p.setTotalAllocation(50);
        p.setUsedCount(0);
    ...
    public void bikeSpecificPromo_ignored_for_other_bike() {
        ...
        Bike bike2 = new Bike();
        bike2.setId(2L);
        bike2.setName("Suzuki Gixxer 250");
        bike2.setPricePerDay(4000);
        bike2.setDeposit(4000);
